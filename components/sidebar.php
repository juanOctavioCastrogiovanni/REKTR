...
<div id="sidebar" class="span3">
    <div class="well well-small"><a id="myCart" href="product_summary"><img src="themes/images/ico-cart.png" alt="cart"><?php if(isset($_SESSION['Cart'])){echo $_SESSION['Cart']->getProducts();}else{echo 0;}  ?> Items in your cart  <span class="badge badge-warning pull-right">$<?php if(isset($_SESSION['Cart'])){echo $_SESSION['Cart']->getTotal();}else{echo 0;}  ?></span></a></div>
