...
<head>
	...
	<link href="<?php echo $point ?>/themes/css/footer.css" rel="stylesheet" type="text/css"> 
		...
		<div class="container">
			...
			<div id="logoArea" class="navbar">
				...
				<div class="navbar-inner">
					<a class="brand" href="<?php echo $point ?>/index" style="text-align:left !important;"><img class="logo" src="<?php echo $point ?>/themes/images/logo-250.png" alt="Bootsshop" /></a>
					<form class="form-inline navbar-search"  style="text-align: center;" method="GET" action="./search.php">
